...
var WaveSurfer = {
    ...
    init: function (params) {
        console.log('wavesurfer.js> Wavesurfer init function with params', params)
    ...
    createDrawer: function () {
        console.log('wavesurfer.js> Wavesurfer __ createDrawer fn');
    ...
    drawBuffer: function () {
        ...
        console.log('wavesurfer.js > Wavesurfer constructor > drawBuffer fn() > nominal width: ', nominalWidth, ' parentWidth:', parentWidth, ' width: ', width )

        // Fill container
        if (this.params.fillParent && (!this.params.scrollParent || nominalWidth < parentWidth)) {
            console.log('in drawBuffer > if statement');
            width = parentWidth;
        }
